...
//TODO lister exemplaires,lister lecteurs,créer la location avec le constructeur à deux paramètres(loueur,exemplaire)
        ...
        do {
            ...
            choixEx = sc.nextInt();
            sc.skip("\n");
        } while(choixEx <1 || choixEx > lex.size());
        ...
        do {
            System.out.println("choix :");
            choixLect = sc.nextInt();
            sc.skip("\n");
        } while(choixLect <1 || choixLect > llect.size());

        Location loc = new Location( llect.get(choixLect-1), lex.get(choixEx-1) );
    ...
    private void gestOuvrages() {
        ...
        switch (choix){
            case 1 :
                ...
                sc.skip("\n");
                TypeLivre tl= TypeLivre.ROMAN; //TODO lire le type de livre => scanf
                String resume = "résumé du livre"; //TODO lire le résumé => scanf
                o=new Livre(titre,ageMin,dp,ploc,langue,genre,isbn,nbrePages,tl,resume);
                ;break;
            case 2 :     //TODO gérer création DVD code, dureeTot, nbrbonus)
